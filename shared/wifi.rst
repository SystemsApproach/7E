...
Alliance, which certifies product compliance with 802.11.
...
other node’s transmission, and nodes can transmit and receive at the
same time, neither of these conditions holds for wireless nodes.  This
...
5.3.1. The main difference from earlier versions is that in Wi-Fi 6.0,
the APs take on additional responsibility coordinating with other
devices as to when transmissions should happen. It does this by
