...
assignment change over time as nodes move around. The two main wireless
...
.. one more issue: wireless capacity is time varying (due to
   interference, path changes etc. Do we want to mention this?
